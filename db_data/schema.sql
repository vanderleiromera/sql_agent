...
GRANT SELECT ON TABLE public.customer TO analyser;
...
GRANT SELECT ON TABLE public.actor TO analyser;
...
GRANT SELECT ON TABLE public.category TO analyser;
...
GRANT SELECT ON TABLE public.film TO analyser;


--
-- Name: TABLE film_actor; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.film_actor TO analyser;


--
-- Name: TABLE film_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.film_category TO analyser;


--
-- Name: TABLE actor_info; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.actor_info TO analyser;
...
GRANT SELECT ON TABLE public.address TO analyser;
...
GRANT SELECT ON TABLE public.city TO analyser;
...
GRANT SELECT ON TABLE public.country TO analyser;


--
-- Name: TABLE customer_list; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.customer_list TO analyser;


--
-- Name: TABLE film_list; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.film_list TO analyser;
...
GRANT SELECT ON TABLE public.inventory TO analyser;
...
GRANT SELECT ON TABLE public.language TO analyser;


--
-- Name: TABLE nicer_but_slower_film_list; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.nicer_but_slower_film_list TO analyser;
...
GRANT SELECT ON TABLE public.payment TO analyser;
...
GRANT SELECT ON TABLE public.rental TO analyser;


--
-- Name: TABLE sales_by_film_category; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.sales_by_film_category TO analyser;
...
GRANT SELECT ON TABLE public.staff TO analyser;
...
GRANT SELECT ON TABLE public.store TO analyser;


--
-- Name: TABLE sales_by_store; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.sales_by_store TO analyser;
...
GRANT SELECT ON TABLE public.staff_list TO analyser;
